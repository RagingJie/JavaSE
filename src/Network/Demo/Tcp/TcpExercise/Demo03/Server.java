package Network.Demo.Tcp.TcpExercise.Demo03;
 ...
 * @Description: 接收客户端上传的文件，上传完毕之后给出反馈
 */
public class Server {
    /*
    ...
    */
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 输出文件地址
        File file = new File("src\\Network\\Demo\\Tcp\\TcpExercise\\Demo03\\ServerDir\\保存图片.png");
